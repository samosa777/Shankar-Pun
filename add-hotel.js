...
document.getElementById("createHotelBtn").addEventListener("click", async () => {
    ...
    if (hotelName === "" || ownerName === "" || mobile === "" || email === "" || password === "") {
    ...
    try {
        ...
        await addDoc(collection(db, "hotels"), {
            hotelUID, hotelName, ownerName, mobile, whatsapp, email, address, city, state, country, maps, website, facebook, instagram, plan, startDate, status, createdAt: serverTimestamp()
        });
